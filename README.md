...
- Feature 1:  Dual Portal System — Separate dashboards for hospital administrators and patients


- Feature 2: Local Storage Database — Data persistence without backend setup


- Feature 3: Multi-Hospital Support — Patients can view and switch between multiple hospitals


- Feature 4: Patient View Dashboard — Patients can check current resource status in real time
